...
const AL = preload("res://Battle Folder/move_arrow_left.tscn")
const AD = preload("res://Battle Folder/move_arrow_down.tscn")
const AU = preload("res://Battle Folder/move_arrow_up.tscn")
const AR = preload("res://Battle Folder/move_arrow_right.tscn")
